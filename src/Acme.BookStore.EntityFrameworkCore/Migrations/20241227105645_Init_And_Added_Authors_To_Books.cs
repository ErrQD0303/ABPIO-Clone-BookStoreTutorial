...
{
    /// <inheritdoc />
    public partial class Init_And_Added_Authors_To_Books : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ErrQD_AppBooks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ErrQD_AppBooks_ErrQD_AppAuthors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "ErrQD_AppAuthors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ErrQD_AppBooks_AuthorId",
