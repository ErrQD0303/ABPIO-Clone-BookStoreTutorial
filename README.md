...
## My BookStore Project's Tutorial With Self-Script
...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p b076de52-c990-44bc-af03-6b89ff16c869
```

> `b076de52-c990-44bc-af03-6b89ff16c869` is the password of the certificate, you can change it to any password you want.
